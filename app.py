...
page = st.sidebar.selectbox('画面選択', ['ユーザー登録', '会議室登録', '会議室予約'])
...
if page == 'ユーザー登録':
    ...
    if submit_button:
        ...
        if booked_num > capacity:
            st.error(f'{room_name}の定員は{capacity}名です．予約人数を見直してください')
        # 開始時刻 ＞＝ 終了時刻
